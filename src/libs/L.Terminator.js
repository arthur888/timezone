...
B.prototype.getJulian = function() {
    /* Calculate the present UTC Julian Date. Function is valid after
     * the beginning of the UNIX epoch 1970-01-01 and ignores leap
     * seconds. */
    return (this.d / 86400000) + 2440587.5;
}

B.prototype.getGMST = function() {
...
L.Terminator = L.Polygon.extend({
	...
	var today = new B(new Date());
	if (time == null)
	    today = new B(new Date());
	else
	    today = new B(new Date(time));
